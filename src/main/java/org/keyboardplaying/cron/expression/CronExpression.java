 ...
 * <p/>
 * The {@link CronExpression} is an immutable object which must be built using the appropriate
 * {@link Builder}.
 *
...
public class CronExpression {
     ...
     * <p/>
     * This can depend upon the CRON syntax being used (Quartz has restrictions on constraints on
     * which constraints can be set on both fields).
     *
     * @author Cyrille Chopelet (http://keyboardplaying.org)
     */
    ...
    public static final class Builder {
        ...
        /** Private constructor to control instanciation. */
        private Builder() {
        }
         ...
         *             if the rule is missing for a field or if the day constraint mode has not been
         *             set
         */
